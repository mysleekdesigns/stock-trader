...
Reads the database URL from application settings and runs migrations
using the asyncpg driver. Supports both online and offline modes.
"""
...
def run_migrations_offline() -> None:
    ...
    Useful for generating migration SQL to apply manually.
    """
...
async def run_async_migrations() -> None:
    ...
    Creates an async engine from the configuration and runs
